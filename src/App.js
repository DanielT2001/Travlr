...
function App() {
  ...
  return (
    <div className="antialiased w-full selection:text-sky-400 selection:bg-yellow-200 relative" ref={el => main = el} id='page'>
      <div className="shadow-inner" id='hero'>
        <header className="lg:px-8 relative z-20">
          <div className="pr-2 pl-0 md:pr-4 md:pl-4 lg:px-12 2xl:px-24 flex justify-between items-center py-4 2xl:py-16 relative z-10" ref={el => nav = el}>
            <div className="">
        ...
        <section className="lg:px-8 relative h-screen z-10">
          <div className="flex flex-col mb-20 sm:mb-0 relative z-0" ref={el => hero = el}>
          ...
          <div className="links flex flex-col space-y-2 pb-4 ml-6 lg:ml-0 2xl:ml-16">
      ...
      {/* Section - 1 */}
      <section className='anim-start1 mb-16 px-2 sm:px-4 lg:px-8 2xl:px-24 pt-16 lg:py-32 flex flex-col'>
        <div className="proposal1 text-xl lg:text-3xl 2xl:text-4xl text-center uppercase text-white">our proposals</div>
        <div className="popular1 text-3xl lg:text-5xl 2xl:text-6xl text-center capitalize text-zinc-700 font-bold mt-3 md:mt-8 mb-8 lg:mb-16 2xl:mb-32">popular destinations</div>
        {/* First Images Row*/}
